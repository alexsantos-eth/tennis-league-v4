  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "group-data-[variant=line]/tabs-list:bg-primary group-data-[variant=line]/tabs-list:data-active:bg-primary dark:group-data-[variant=line]/tabs-list:data-active:border-transparent dark:group-data-[variant=line]/tabs-list:data-active:bg-primary",
        "data-active:bg-primary data-active:text-foreground dark:data-active:border-input dark:data-active:bg-primary/30 dark:data-active:text-foreground",
